...
export class Grid {
	...
	private onWheel(e: WheelEvent) {
		this.zoomFactor *= e.deltaY > 0 ? 1 - Grid.ZOOM_SENSITIVITY : 1 + Grid.ZOOM_SENSITIVITY;
		this.zoomFactor = Math.max(Grid.MIN_ZOOM, Math.min(Grid.MAX_ZOOM, this.zoomFactor));
